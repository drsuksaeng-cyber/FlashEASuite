...
// Include the main strategy (using double quotes for local project files)
...
input int      InpMaxGridLevels = 3;              // Max Grid Levels
...
input double   InpProfitTargetMult = 2.0;         // Profit Target Multiplier
input double   InpTrailingThreshold = 0.6;        // Trailing Threshold (70%)
input int      InpMaxDurationHours = 48;          // Max Duration (hours)
