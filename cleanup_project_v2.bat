@echo off
REM ========================================================================
REM FlashEASuite V2 - COMPLETE Project Cleanup Script v2
REM ========================================================================
REM Purpose: 
...
echo.
echo ========================================================================
echo FlashEASuite V2 - COMPLETE Project Cleanup Script v2
echo ========================================================================
echo.
...
REM ========================================================================
REM STEP 3: DELETE EMPTY FILES
REM ========================================================================

echo.
echo ========================================================================
echo STEP 3: Deleting empty files...
echo ========================================================================
...
if %MODULES_OK%==0 (
    ...
    echo Please extract FlashEA_Refactored_Complete.zip first.
)

REM ========================================================================
REM STEP 7: CREATE INSTALLATION FOLDERS (IF NOT EXIST)
REM ========================================================================

echo.
echo ========================================================================
echo STEP 7: Preparing installation folders...
echo ========================================================================

REM Python core/strategy folder
...
if exist "python_strategy" (
    ...
    echo   [MISSING] python_strategy\ - Extract FlashEA_Refactored_Complete.zip
)
if exist "mql_protocol" (
    echo   [OK] mql_protocol\ ^(3 files^)
) else (
    echo   [MISSING] mql_protocol\ - Extract FlashEA_Refactored_Complete.zip
)
if exist "mql_grid" (
    echo   [OK] mql_grid\ ^(4 files^)
) else (
    echo   [MISSING] mql_grid\ - Extract FlashEA_Refactored_Complete.zip
)
echo.
echo ========================================================================
pause
