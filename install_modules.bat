@echo off
REM ========================================================================
REM FlashEASuite V2 - Module Installation Script
REM ========================================================================
REM Purpose: Install Python and MQL5 modules after cleanup
REM Prerequisite: Run cleanup_project_v2.bat first
REM Date: December 6, 2025
REM ========================================================================

echo.
echo ========================================================================
echo FlashEASuite V2 - Module Installation Script
echo ========================================================================
echo.
...
echo.
echo Prerequisite: cleanup_project_v2.bat must be run first
echo.
pause
...
if %READY%==0 (
    ...
    echo.
    echo Please:
    echo   1. Extract FlashEA_Refactored_Complete.zip to project root
    echo   2. Run cleanup_project_v2.bat
